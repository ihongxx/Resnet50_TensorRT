...
if __name__ == '__main__':
    ...
    parser.add_argument('--cache_file', type=str, default='./data/resnet50_calibration.cache')
    parser.add_argument('--mode', type=str, default='int8')
    parser.add_argument('--img_dir', type=str, default='E:/Datasets/IMAGES/image_cls/ILSVRC2012_img_val/')
